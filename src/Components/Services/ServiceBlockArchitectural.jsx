    ...
    <>
      <li className="flex gap-2 transition-all duration-300 hover:translate-x-2">
        ...
        <div className="flex-1">
          <span className="font-inter" style={{ fontSize: '16px' }}>Планировочное решение Позиционирование дома на участке</span>
          <div className="mt-2 font-inter" style={{ fontSize: '16px', color: '#00000099' }}>
            Ситуационный план с прилегающей территорией
          </div>
        </div>
      </li>
      <li className="flex gap-2">
        ...
        <div className="flex-1">
          <span className="font-inter" style={{ fontSize: '16px' }}>Концепция по материалам и формам фасадов Аксонометрическая</span>
          <div className="mt-2 font-inter" style={{ fontSize: '16px', color: '#00000099' }}>
            архитектурная модель в Revit
          </div>
        </div>
      </li>
      <li className="flex gap-2">
        ...
        <div className="flex-1">
          <span className="font-inter" style={{ fontSize: '16px' }}>Экстерьерные визуализации</span>
        </div>
      </li>
    </>
  );
        ...
        <div className="flex flex-col justify-start pt-16 md:pt-24 lg:pt-32 xl:pt-40 2xl:pt-48">
          ...
          <div className="mb-6 md:mb-8">
            <p className="text-sm sm:text-base md:text-lg text-gray-600 font-inter">
              Топографическая съемка участка не учтена
            </p>
          </div>
          ...
          <div className="mb-6 md:mb-8">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-base sm:text-lg md:text-xl lg:text-2xl font-inter font-medium">3 месяца</span>
            </div>
          </div>
          ...
          <div>
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-base sm:text-lg md:text-xl lg:text-2xl font-inter font-medium">2 500 Р / м²</span>
            </div>
          </div>
        </div>
      </div>
